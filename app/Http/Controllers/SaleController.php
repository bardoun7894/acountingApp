...
//             ->where("allowtax", 1)
//             ->where("store_id", Auth::user()->store_id)
//             ->selectRaw("sum(sales.sale_qty * sales.sale_unit_price) as total")
//             ->first();
...
//             " Sale To " . $customer->supplier_name_en,
//             isset($customer->supplier_name_ar)
//                 ? $customer->supplier_name_ar . "البيع الى "
//                 : $customer->supplier_name_en . "البيع الى "
//         );
...
//         $setdebitEntry->account_sub_control_id =
//             $debitEntry->account_sub_control_id; //these form Account Setting $debitEntry
...
//         $setdebitEntry->transaction_title_en =
//             " Purchase From " . $customer->customer_name_en;
//         $setdebitEntry->transaction_title_ar = isset(
//             $customer->customer_name_ar
//         )
//             ? $customer->customer_name_ar . "الشراء من "
//             : $customer->customer_name_en . "الشراء من ";
//         $setdebitEntry->save();
...
//         $setcreditEntry->account_sub_control_id =
//             $creditEntry->account_sub_control_id; //these form Account Setting $debitEntry
...
//         $setcreditEntry->transaction_title_en =
//             " Purchase Payment Pending ( " . $customer->customer_name_en . ")";
//         $setcreditEntry->transaction_title_ar = isset(
//             $customer->customer_name_ar
//         )
...
//             $setdebitEntry->financial_year_id = $financial_year->id;
//             $setdebitEntry->account_head_id = $debitEntry->account_head_id; //these form Account Setting $debitEntry
//             $setdebitEntry->account_control_id =
//                 $debitEntry->account_control_id; //these form Account Setting $debitEntry
//             $setdebitEntry->account_sub_control_id =
//                 $debitEntry->account_sub_control_id; //these form Account Setting $debitEntry
//             $setdebitEntry->invoice_number = $invoice_number;
//             $setdebitEntry->transaction_date = $invoice_date;
...
//             $setcreditEntry->financial_year_id = $financial_year->id;
//             $setcreditEntry->account_head_id = $creditEntry->account_head_id; //these form Account Setting $debitEntry
//             $setcreditEntry->account_control_id =
//                 $creditEntry->account_control_id; //these form Account Setting $debitEntry
//             $setcreditEntry->account_sub_control_id =
//                 $creditEntry->account_sub_control_id; //these form Account Setting $debitEntry
//             $setcreditEntry->invoice_number = $invoice_number;
//             $setcreditEntry->transaction_date = $invoice_date;
...
//                 $customer->customer_name_ar
//             )
//                 ? " ( " . $customer->customer_name_ar . "تم الدفع ( "
//                 : " ( " . $customer->customer_name_en . "تم الدفع ( ";
//             $setcreditEntry->save();
//         }
...
//             ->where("customer_invoice_id", $customerInvoiceId)
//             ->get();
...
//         return view("admin.includes.sales.allSales")->with(
