            ...
            <div class="card-header">
                ...
                <div class="heading-elements">
                    <ul class="list-inline mb-0">
                        <li><a class="btn btn-sm btn-blue box-shadow-2 round btn-min-width pull-right" href="{{url('stocks/create')}}" target="_blank">Add Category</a></li>
                    </ul>
                </div>
            </div>
...
{{--                            <th class="border-top-0">arabic FullName</th>--}}
                        ...
                        @foreach($stocks as $stock)
                           <tbody>
                            ...
                            <td class="text-truncate"> {{$stock->id}}</td>
{{--                            <td class="text-truncate">  @if($stock->user_type_id==1 ) admin @else Category  @endif       </td>--}}
                            <td class="text-truncate"> {{$stock->category_name}}</td>
{{--                            <td class="text-truncate"> {{$stock->full_name_ar}}</td>--}}
