                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ url('/purchases') }}">{{ __('messages.purchases') }}</a>
                            </li>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        <a class="dropdown-item" href="{{ url('/getStockInvoice') }}">
                            {{ __('messages.purchase_invoice') }}</a>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-12 mb-2">
                                                        ...
                                                        <input type="number" id="eventRegInput2" class="form-control"
                                                            value="{{ $purchase->purchase_qty }}" placeholder="Quantity"
                                                            name="quantity">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row justify-content-md-center">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="form-group col-12 mb-2">
                                                        <label
                                                            for="eventRegInput2">{{ __('messages.purchase_unit_price') }}</label>

                                                        <input type="number" id="eventRegInput2" class="form-control"
                                                            value="{{ $purchase->purchase_unit_price }}"
                                        ...
                                        <div class="row justify-content-md-center">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="form-group col-12 mb-2">
                                                        <label
                                                            for="eventRegInput2">{{ __('messages.sale_unit_price') }}</label>

                                                        <input type="number" id="eventRegInput2" class="form-control"
                                                            value="{{ $purchase->sale_unit_price }}"
                                                            placeholder="Sale Unit Price" name="sale_unit_price">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row justify-content-md-center">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="form-group col-12 mb-2">
                                                        <label
                                                            for="eventRegInput2">{{ __('messages.expiry_date') }}</label>
