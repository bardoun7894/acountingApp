            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form class="form" method="POST" action="{{url('purchases/'.$purchase->id)}}">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="col-md-6">
                                  ...
                                  <input id="input_purchase_category_id" value="{{$purchase->category_id}}" hidden>

                                    <div id="appendPurchaseCategoryLevel">
                                        @include("admin.includes.purchases.append_purchase_category_level")
                                    </div>

                                   <input id="input_stock_id" value="{{$purchase->stock_id}}" hidden>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="form-group col-12 mb-2">
                                                    ...
                                                    <input type="number" id="eventRegInput2" class="form-control" value="{{$purchase->purchase_qty}}" placeholder="Quantity" name="quantity" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="form-group col-12 mb-2">
                                                    ...
                                                    <input type="number" id="eventRegInput2" class="form-control"  value="{{$purchase->purchase_unit_price}}" placeholder="Purchase Unit Price" name=" current_purchase_unit_price">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="form-group col-12 mb-2">
                                                    ...
                                                    <input type="number" id="eventRegInput2" class="form-control" value="{{$purchase->sale_unit_price}}" placeholder="Sale Unit Price" name="sale_unit_price">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="form-group col-12 mb-2">
                                                    ...
                                                    <input type="date" id="eventRegInput2" class="form-control" value="{{$purchase->expiry_date}}"  placeholder="Expiry Date" name="expiry_date">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="form-group col-12 mb-2">
                                                    ...
                                                    <input type="date" id="eventRegInput2" class="form-control" value="{{$purchase->manufacture_date}}" placeholder="Manufacture Date"  name="manufacture_date">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="form-group col-12 mb-2">
                                                <input type="text" id="eventRegInput2" class="form-control" value="{{$purchase->$description}}" placeholder="Description" name="{{$description}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
