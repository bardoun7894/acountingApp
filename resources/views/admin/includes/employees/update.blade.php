    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{ __('messages.edit_employee') }}</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ __('messages.update_employee') }}
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                    <button class="btn btn-info round dropdown-toggle dropdown-menu-right box-shadow-2 px-2 mb-1"
                        ...
                        aria-expanded="false"><i class="ft-settings icon-left"></i> {{ __('messages.settings') }}</button>
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <form class="form" method="POST"
                                    action="{{ url('/' . $lang . '/employees/' . $employee->id) }}">
                                    @csrf
                                    @method('PUT')
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-12 mb-2">
                                                        ...
                                                        <input type="number" id="eventRegInput2" class="form-control"
                                                            ...
                                                            name="employee_contact_number" min="0" maxlength="10"
