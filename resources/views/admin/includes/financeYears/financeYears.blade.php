                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            <li><a class="btn btn-sm btn-blue box-shadow-2 round btn-min-width pull-right"
                                    href="{{ url('financeYears/create') }}"
                                    target="_self">{{ __('messages.add_branch') }}</a></li>
                        </ul>
                    </div>
                </div>
                                ...
                                @foreach ($financeYears as $financeYear)
                                    <tr>
                                        ...
                                        <td class="text-truncate"> <a
                                                href="{{ url('financeYears/' . $financeYear->id . '/edit') }}"><i
                                                    class="la la-edit" style="color: green;font-size: 25px"></i></a>
                                        </td>
                                        <td>
                                            <a class="confirmDelete" record="FinanceYear"
                                                recordId="{{ $financeYear->id }}">
