                            ...
                            <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-9 mb-2">
                                            <input type="text" id="eventRegInput2" class="form-control" placeholder="{{__('messages.financeYears')}}" name="financial_year">
                                        </div>
                                ...
                                <div class="row">
                                        <div class="form-group col-6 mb-2">
                                            ...
                                            <input type="date" id="eventRegInput2" class="form-control" placeholder="{{__('messages.startDate')}}" name="startDate">
                                        </div>
                                    <div class="form-group col-6 mb-2">
                                            <label for="eventRegInput2">{{__('messages.endDate')}}</label>
                                            <input type="date" id="eventRegInput2" class="form-control" placeholder="{{__('messages.endDate')}}" name="endDate">
                                        </div>
                                    </div>
