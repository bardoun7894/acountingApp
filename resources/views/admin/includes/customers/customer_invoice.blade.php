                                ...
                                <div class="table-responsive col-12">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right">{{__('messages.phoneNumber')}}</th>
                                            <th class="text-right">{{__('messages.address')}}</th>
                                            <th class="text-right">{{__('messages.description')}}</th>
                                            <th class="text-right">{{__('messages.area')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @foreach($customers as $customer)
                                            <tr>
                                                ...
                                                <td class="text-right"> {{$customer->contact_number}}</td>
                                                <td class="text-right"> {{$customer->$address}}</td>
                                                <td class="text-right"> {{$customer->$description}}</td>
                                                <td class="text-right"> {{$customer->area}}</td>
                                            </tr>
                                        @endforeach
