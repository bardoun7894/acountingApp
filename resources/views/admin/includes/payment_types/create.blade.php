        ...
        <div class="card">
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    ...
                    <form class="form" method="POST" action="{{url('/'.$lang.'/units')}}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 mb-2">
                                            ...
                                            <input type="text" id="eventRegInput2" class="form-control" placeholder="{{__('messages.unit_name')}}" name="{{$unit_name}}">
                                        </div>
                                    </div>
