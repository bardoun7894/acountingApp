            ...
            <div class="card-header">
                ...
                <div class="heading-elements">
                    <ul class="list-inline mb-0">
                        <li><a class="btn btn-sm btn-blue box-shadow-2 round btn-min-width pull-right" href="{{url('accountControls/create')}}" target="_self">{{__('messages.add_account_control')}}</a></li>
                    </ul>
                </div>
            </div>
