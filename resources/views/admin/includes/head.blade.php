...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ url('admin/app-assets/vendors/css/weather-icons/climacons.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ url('admin/app-assets/vendors/css/charts/chartist-plugin-tooltip.css') }}">
    <!--  END : Vendor CSS-->
    ...
    <!--  BEGIN : Page CSS -->
    <link rel="stylesheet" type="text/css"
        href="{{ url('admin/app-assets/css/core/menu/menu-types/vertical-menu-modern.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('admin/app-assets/css/core/colors/palette-gradient.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('admin/app-assets/css/pages/login-register.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('admin/app-assets/css/pages/dashboard-jsecommerce.css') }}">
    <!-- END: Page CSS-->
