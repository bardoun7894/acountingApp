                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            <li><a class="btn btn-sm btn-blue box-shadow-2 round btn-min-width pull-right"
                                    href="{{ url('payment_types/create') }}"
                                    target="_self">{{ __('messages.add_PaymentType') }}</a></li>
                        </ul>
                    </div>
                </div>
                                ...
                                @foreach ($payment_types as $payment_type)
                                    <tr>
                                        ...
                                        <td class="text-truncate"> <a
                                                href="{{ url('payment_types/' . $payment_type->id . '/edit') }}"><i
                                                    class="la la-edit" style="color: green;font-size: 25px"></i></a>
                                        </td>
                                        <td>
                                            <a class="confirmDelete" record="PaymentType"
                                                recordId="{{ $payment_type->id }}"> <i class="la la-trash"
