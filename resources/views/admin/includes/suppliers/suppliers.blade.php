                ...
                <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        <a class="dropdown-item"
                            href="{{ url('/getSupplierInvoice') }}">{{ __('messages.supplier_invoice') }}</a>
                        </a>
                        ...
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li><a class="btn btn-sm btn-blue box-shadow-2 round btn-min-width pull-right"
                                        ...
                                        target="_self">{{ __('messages.add_suplier') }}</a></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                @foreach ($suppliers as $supplier)
                                    <tr>
                                        ...
                                        <td class="text-truncate"> <a
                                                href="{{ url('suppliers/' . $supplier->id . '/edit') }}"><i
                                                    class="la la-edit" style="color: green;font-size: 25px"></i></a>
                                        </td>
                                        <td>
                                            <a class="confirmDelete" record="Supplier" recordId="{{ $supplier->id }}">
