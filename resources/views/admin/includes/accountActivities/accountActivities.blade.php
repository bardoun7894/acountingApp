            ...
            <div class="card-header">
                ...
                <div class="heading-elements">
                    <ul class="list-inline mb-0">
                        <li><a class="btn btn-sm btn-blue box-shadow-2 round btn-min-width pull-right" href="{{url('accountActivities/create')}}" target="_self">{{__("messages.add_account_activity")}}</a></li>
                    </ul>
                </div>
            </div>
...
{{--                            <td class="text-truncate"> {{$user->user_type->$user_type }} </td>--}}
                            <td class="text-truncate">   <a href="{{url('accountActivities/'.$accountActivity->id.'/edit')}}"><i class="la la-edit" style="color: green;font-size: 25px"></i></a> </td>
                            <td>
                                <a  class="confirmDelete"  record="AccountActivity"  recordId="{{$accountActivity->id}}">  <i class="la la-trash" style="color: red;font-size: 25px"></i>
                                </a>
                            </td>
