...
return [
    ...
    */
    ...
    "companies" => "الشركات",
    "financeYears" => "السنوات المالية",
    "add_financeYear" => "أضف سنة مالية",
    ...
    "add_account_head" => "  اضافة رأس الحساب جديد",
    ...
    "sell_type_name" => "اسم نوع البيع",
    "history_payments"=> "تاريخ المدفوعات",
    ...
    ####################### customer ################################
    "create_customer" => "اضا فة  زبون",
    "add_customer" => "اضافة  زبون",
    "update_customer" => "تعديل معلومات زبون",
    ...
    */
    ...
    "create_employee" => "أضف موظف جديد",
    "employee_name" => "اسم الموظف",
    "employee_email" => "البريد الإلكتروني للموظف",
    "employee_phone" => "رقم الهاتف للموظف",
    "employee_address" => "عنوان الموظف",
    "employee_salary" => "الراتب للموظف",
    "employee_type" => "نوع الموظف",
    "employee_branch" => "الفرع للموظف",
    "employee_status" => "حالة الموظف",
    "employee_image" => "صورة الموظف",
    "no_employees_for_this_company" => "لا يوجد موظفين لهذه الشركة",
    "designation" => "التعيين",
    "cnic" => "الرقم الوطني",
    ...
    "purchases_invoice_payment" => "دفع فاتورة المشتريات",
    ####################### options ################################
