...
class AccountHeadSeeder extends Seeder
{
   ...
   $data=[
    ...
    ['id'=>3, 'user_id'=>1 ,'account_head_name_en'=>'Revenue','account_head_name_ar'=>'الايرادات', 'account_code'=>'3'],
    ['id'=>4, 'user_id'=>1 ,'account_head_name_en'=>'Expenses','account_head_name_ar'=>'المصروفات', 'account_code'=>'4'],
   ];
